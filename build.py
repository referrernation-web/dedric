...
.hero video{object-fit:contain!important;object-position:50% 50%!important}@media(max-width:980px){.hero video{object-position:50% 0!important}}.rv[data-rv=z]{opacity:1!important}</style></head><body>
...
<header class="hero" id="home">
  ...
  <div class="wrap hcontent" data-depth="8">
    ...
    <div class="cta"><a class="btn light" href="#projects">View Case Studies</a><a class="btn ghosty" href="world/" title="3D resume: ride Rev across the cities where the career happened">&#127758; Ride the 3D World</a><a class="btn ghosty" href="assets/Dedric-Brown-Resume-2026.pdf" target="_blank" rel="noopener">Resume PDF</a><a class="btn ghosty" href="assets/Dedric-Brown-Resume-2026.docx" download>Resume DOCX</a></div>
  </div>
...
var zio=new IntersectionObserver(function(en){en.forEach(function(x){if(x.isIntersecting){x.target.classList.add('in');zio.unobserve(x.target);}})},{threshold:0,rootMargin:'0px 0px -40px 0px'});document.querySelectorAll('.rv[data-rv=z]').forEach(function(w){zio.observe(w)});
