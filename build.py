...
(function(){var DBG=/mgdebug/.test(location.search);function dbg(m){if(!DBG)return;var d=document.getElementById('mgdbg')||document.body.appendChild(Object.assign(document.createElement('div'),{id:'mgdbg'}));d.style.cssText='position:fixed;left:8px;bottom:8px;z-index:999;background:#111;color:#0f0;font:12px monospace;padding:8px 10px;border-radius:8px;max-width:90vw;white-space:pre-wrap';d.textContent+=m+'
';}
dbg('mg: width='+innerWidth+' reducedMotion='+matchMedia('(prefers-reduced-motion:reduce)').matches+' saveData='+!!(navigator.connection&&navigator.connection.saveData));
if(innerWidth<700){dbg('mg: OFF (viewport under 700px)');return;}
var host=document.getElementById('rright');if(!host){dbg('mg: OFF (no #rright)');return;}
var META={"d-run": [148, 360], "d-jump": [148, 476], "d-cling": [193, 335], "d-sit": [129, 287], "p-run": [206, 241], "p-jump": [213, 310], "p-cling": [213, 241], "p-sit": [206, 200]};var FB={'d-':'data:image/png;base64,','p-':'data:image/png;base64,'};var READY={};var FBW={'d-':0.4111,'p-':0.8500};
var G=2600,FALL=1.6,Wp=[],started=false,mg,sec=document.getElementById('expertise');
function fx(cls,x,y,n,spread,dy){for(var i=0;i<n;i++){var d=document.createElement('div');d.className=cls;d.style.left=(x+(Math.random()*spread-spread/2))+'px';d.style.top=(y-4)+'px';d.style.setProperty('--dx',(Math.random()*36-18)+'px');if(dy)d.style.setProperty('--dy',dy);mg.appendChild(d);setTimeout(function(el){return function(){el.remove()}}(d),520);}}
function way(){Wp=[];var hr=host.getBoundingClientRect();[].forEach.call(host.querySelectorAll('.pin'),function(p){var l=p.querySelector('.ledge');var r=(l||p).getBoundingClientRect();Wp.push({x:r.left-hr.left+r.width/2,y:r.top-hr.top-2,el:p});});}
function Ent(pre,h){var el=document.createElement('div');el.className='mg-spr';var sh=document.createElement('div');sh.className='mg-sh';mg.appendChild(sh);mg.appendChild(el);
this.el=el;this.sh=sh;this.pre=pre;this.h=h;this.cur=0;this.x=0;this.y=0;this.vx=0;this.vy=0;this.on=true;this.st='idle';this.stT=0;this.fr=0;this.ft=0;this.face=1;this.sk='';this.w=0;this.log=[];}
Ent.prototype.setSprite=function(n){var key=this.pre+n;if(!READY[key]){if(this.sk==='fb')return;this.sk='fb';this.w=this.h*FBW[this.pre];this.el.style.width=this.w+'px';this.el.style.height=this.h+'px';this.el.style.backgroundImage='url('+FB[this.pre]+')';this.el.style.backgroundSize=this.w+'px '+this.h+'px';this.el.style.backgroundPosition='0 0';return;}if(this.sk===n)return;this.sk=n;var m=META[key];var sc=this.h/m[1];this.w=m[0]*sc;this.el.style.width=this.w+'px';this.el.style.height=this.h+'px';this.el.style.backgroundImage='url(assets/spr/'+key+'.webp)';this.el.style.backgroundSize=(m[0]*8*sc)+'px '+this.h+'px';};
Ent.prototype.showFrame=function(fr){if(this.sk==='fb')return;var m=META[this.pre+this.sk];var sc=this.h/m[1];this.el.style.backgroundPosition=(-Math.max(0,Math.min(7,fr))*m[0]*sc)+'px 0';};
Ent.prototype.sitAnim=function(dt){if(META[this.pre+'sit']){this.setSprite('sit');this.ft+=dt;if(this.ft>0.11){this.ft=0;this.fr=(this.fr+1)%8;}this.showFrame(this.fr);}else{this.setSprite('run');this.showFrame(0);}};
Ent.prototype.go=function(st){if(this.st!==st){this.st=st;this.stT=0;this.log.push(st);if(this.log.length>30)this.log.shift();}};
Ent.prototype.launchUp=function(){var n=this.cur-1;if(n<0)return;var B=Wp[n];this.tgt=n;this.climb=true;this.on=false;
this.vx=(B.x+(Wp[this.cur].x<B.x?-1:1)*171-this.x)*2.2;this.vy=-540;this.go('jump');};
Ent.prototype.launchDirect=function(want){var t=this,B=Wp[want];var dy=Math.max(40,t.y-B.y);var vy=-Math.sqrt(2*G*(dy+90));var tu=-vy/G,h=vy*vy/(2*G),td=Math.sqrt(2*Math.max(1,h-dy)/(G*FALL));var T=tu+td;t.vx=(B.x-t.x)/T;t.vy=vy;t.tgt=want;t.climb=false;t.on=false;t.fast=true;t.go('kick');};
Ent.prototype.walk=function(dt,fps){var t=this;if(t.bouncy){t.setSprite('run');t.ft+=dt;if(t.ft>0.10){t.ft=0;t.fr=(t.fr+1)%8;}t.showFrame(t.fr);t.bob=Math.abs(Math.sin((t.fr+t.ft*10)/8*Math.PI*2))*2;t.tilt=0;}else{t.bob=0;t.setSprite('run');t.ft+=dt;if(t.ft>1/(fps||12)){t.ft=0;t.fr=(t.fr+1)%8;}t.showFrame(t.fr);}};
Ent.prototype.step=function(dt,target){this.stT+=dt;var t=this;var NB=Wp.length;if(!NB)return;t.bob=0;t.tilt=0;
var want=Math.round(Math.max(0,Math.min(NB-1,target)));var back=want-t.cur;
if(t.st==='idle'||t.st==='run'){t.on=true;t.y=Wp[t.cur].y;
 if(want>t.cur){t.fast=back>=2;t.longTo=back>=3?want:null;t.go('crouch');}
 else if(want<t.cur){if(-back>=2)t.launchDirect(want);else{t.fast=false;t.launchUp();}}
 else if(t.hopReq){t.hopReq=false;t.tgt=t.cur;t.climb=false;t.vx=0;t.vy=-430;t.on=false;t.fast=false;t.go('jump');}
 else if(t.sit){if(t.bouncy&&!t.sleepy){t.sitAnim(dt);}else{t.setSprite('jump');t.showFrame(t.sleepy?7:0);}}
 else if(t.pat){var span=104;t.x+=t.pdir*62*dt;if(t.x>Wp[t.cur].x+span){t.x=Wp[t.cur].x+span;t.pdir=-1;}if(t.x<Wp[t.cur].x-span){t.x=Wp[t.cur].x-span;t.pdir=1;}t.face=t.pdir;t.walk(dt,12);}
 else if(t.seek!==undefined&&t.seek!==null){var dx=t.seek-t.x;if(Math.abs(dx)>6){var spd=Math.abs(dx)>40?110:62;t.x+=Math.sign(dx)*Math.min(Math.abs(dx),spd*dt);t.face=dx>0?1:-1;t.walk(dt,12);}else if(t.bouncy){t.setSprite('run');t.showFrame(0);}else{t.setSprite('jump');t.showFrame(0);}}
 else{if(t.bouncy){t.setSprite('run');t.showFrame(0);}else{t.setSprite('run');t.ft+=dt;if(t.ft>0.10){t.ft=0;t.fr=(t.fr+1)%8;}t.showFrame(t.fr);}}}
if(t.st==='crouch'){t.setSprite('jump');t.showFrame(0);
 if(t.stT>(t.fast?0.02:0.09)){var n=(t.longTo!=null)?t.longTo:t.cur+1,A=Wp[t.cur],B=Wp[n];var dy=Math.max(0,B.y-A.y);var T=(t.fast?0.38:0.55)+dy/1400;t.vx=(B.x+(t.off||0)-t.x)/T;t.vy=-620;t.on=false;t.climb=false;t.go('jump');t.tgt=n;t.longTo=null;}}
if(t.st==='jump'||t.st==='fall'||t.st==='kick'){
 t.vy+=G*(t.vy>0?FALL:1)*dt;t.x+=t.vx*dt;var py=t.y;t.y+=t.vy*dt;
 if(t.vy>0&&t.st==='jump')t.go('fall');
 t.setSprite('jump');var ph=t.vy<-300?1:(t.vy<0?2:(t.vy<400?4:6));t.showFrame(t.st==='kick'?2:ph);
 var B=Wp[t.tgt];
 if(t.climb&&t.st!=='kick'&&t.vy>-420){var face=B.x+(t.x<B.x?-1:1)*171;
  if(Math.abs(t.x-face)<24&&t.y>B.y+4){t.x=face;t.vx=0;t.go('slide');}}
 if(t.vy>0&&py<=B.y&&t.y>=B.y&&Math.abs(t.x-B.x)<190){t.y=B.y;t.vy=0;t.vx=0;t.on=true;t.cur=t.tgt;t.climb=false;t.go('land');if(t.onLand)t.onLand(t.cur);
  fx('mg-dust',B.x,B.y+4,5,40);var el=B.el;el.style.transition='transform .18s cubic-bezier(.3,1.6,.4,1)';el.style.transform='rotate(var(--rot)) translateY(4px)';setTimeout(function(){el.style.transform=''},190);}
 if(t.y>Wp[NB-1].y+420){t.y=Wp[t.cur].y;t.x=Wp[t.cur].x;t.vy=0;t.vx=0;t.on=true;t.climb=false;t.go('idle');}}
if(t.st==='slide'){t.setSprite('cling');t.ft+=dt;if(t.ft>0.06){t.ft=0;t.fr=(t.fr+1)%8;fx('mg-spark',t.x,t.y-t.h*0.4,1,8,'-6px');}t.showFrame(t.fr);
 t.vy=Math.min(t.vy+G*dt,120);t.y+=t.vy*dt;
 if(t.stT>0.16){var B=Wp[t.tgt];t.y=Math.min(t.y,B.y+60);t.vx=(B.x-t.x)*3.0;t.vy=-940;t.go('kick');}}
if(t.st==='land'){t.setSprite('jump');t.showFrame(7);if(t.stT>(t.fast?0.02:0.10))t.go('idle');}
t.face=t.vx>10?1:(t.vx<-10?-1:t.face);
var sq=1,sw=1;
if(t.st==='crouch'){sq=0.85;sw=1.1}else if(t.st==='land'){sq=0.82;sw=1.14}else if(!t.on&&Math.abs(t.vy)>500){sq=1.07;sw=0.95}
if(t.bob){sq=1-t.bob/60;sw=1+t.bob/90;}var fl=((t.flipRun&&t.sk==='run')||(t.flipSit&&t.sk==='sit'))?-1:1;t.el.style.transformOrigin='50% 100%';t.el.style.transform='translate3d('+(t.x-t.w/2)+'px,'+(t.y-t.h+4-(t.bob||0))+'px,0) rotate('+((t.tilt||0)*t.face)+'deg) scaleX('+(t.face*sw*fl)+') scaleY('+sq+')';
var gb=Wp[Math.max(0,Math.min(NB-1,t.on?t.cur:t.tgt||0))];
t.sh.style.left=t.x+'px';t.sh.style.top=(gb.y+6)+'px';var air=Math.min(1,Math.abs(gb.y-t.y)/220);t.sh.style.transform='translateX(-50%) scale('+(1-air*0.55)+')';};
var Dn,Pp,tag,lastT=0,sched=0;function preload(){Object.keys(META).forEach(function(k){if(READY[k]||READY[k]===false)return;READY[k]=false;var im=new Image();im.onload=function(){READY[k]=true;dbg('mg: sprite ok '+k);if(Dn){Dn.sk='';Pp.sk='';}};im.onerror=function(){dbg('mg: sprite FAILED '+k)};im.src='assets/spr/'+k+'.webp';});}
var ab=document.getElementById('about');if(ab){var pio=new IntersectionObserver(function(en){en.forEach(function(x){if(x.isIntersecting){preload();pio.disconnect();}})},{rootMargin:'300px'});pio.observe(ab);}
function start(){if(started)return;started=true;dbg('mg: started, pins='+host.querySelectorAll('.pin').length);preload();mg=document.createElement('div');mg.id='mg';host.appendChild(mg);way();
Dn=new Ent('d-',96);Pp=new Ent('p-',58);Pp.off=-58;Pp.bouncy=true;Pp.flipRun=false;Pp.flipSit=false;Dn.setSprite('run');Pp.setSprite('run');
Dn.x=Wp[0].x;Dn.y=Wp[0].y;Pp.x=Wp[0].x-60;Pp.y=Wp[0].y;
tag=document.createElement('div');tag.className='mg-tag';tag.textContent='DEDRIC';mg.appendChild(tag);var tag2=document.createElement('div');tag2.className='mg-tag mg-tag2';tag2.textContent='REV';mg.appendChild(tag2);
window.addEventListener('resize',way);setTimeout(way,700);setTimeout(way,2200);host.addEventListener('transitionend',function(e){if(e.target.classList&&e.target.classList.contains('pin'))way();});if(document.fonts&&document.fonts.ready)document.fonts.ready.then(way);window.addEventListener('load',way);
lastT=performance.now();sched=requestAnimationFrame(tick);
Dn.onLand=function(i){var t=performance.now();if(!saidAt[i]||t-saidAt[i]>15000){saidAt[i]=t;say(LINES[i]||'',2600);}};
host.addEventListener('mousemove',function(e){var hr=host.getBoundingClientRect();cursorX=e.clientX-hr.left;},{passive:true});host.addEventListener('mouseleave',function(){cursorX=null;});
[].forEach.call(host.querySelectorAll('.pin'),function(p,i){p.addEventListener('mouseenter',function(){hoverT=i;wake();});p.addEventListener('mouseleave',function(){hoverT=null;});});
tag.addEventListener('click',function(){wake();say("Hi, I'm Dedric. Scroll or hover a card and Rev and I will jump there.",3800);Dn.hopReq=true;});
var pb=document.getElementById('mgplay');if(pb){pb.addEventListener('click',function(){if(tour){clearInterval(tour);tour=null;pb.classList.remove('on');return;}pb.classList.add('on');var top=sec.getBoundingClientRect().top+scrollY;var h=sec.offsetHeight;var steps=[0.02,0.3,0.55,0.8,1.0,0.8,0.55,0.3,0.02],k=0;function go(){if(k>=steps.length){clearInterval(tour);tour=null;pb.classList.remove('on');return;}scrollTo({top:top+h*steps[k]-innerHeight*0.45,behavior:'smooth'});k++;}go();tour=setInterval(go,1900);dbg('mg: tour');});
['wheel','touchstart','keydown'].forEach(function(ev){addEventListener(ev,function(){if(tour){clearInterval(tour);tour=null;pb&&pb.classList.remove('on');}},{passive:true});});}
window.__mg={D:Dn,P:Pp,Wp:Wp,tick:tick,way:way,say:say,st:scrollTarget};}
var BARKS=['Beep!','Boop-beep!','Beep?'];var REPLY=['Come on, Rev!','This way, Rev!','One second, Rev.'];var barkT=3,bub2,bub2T=0,replyT=0;
var LINES=['Roadmap ownership: vision, intake, acceptance criteria, then the numbers Finance signs.','Salesforce to NetSuite, quote to cash. One system of record.','GTM and RevOps: pipeline, forecasting, renewals. Time-to-insight down 40%.','Agentforce, but governed first. Two workflows held until the data was ready.'];
var lagFace=1,lagFaceRaw=1,lagT=0;var idleT=0,lastScrollY=scrollY,autoT=null,autoTimer=0,aiNext=2.5,hoverT=null,cursorX=null,bub,bubTimer=0,saidAt={},tour=null,sleepSaid=false;
function bark(txt,ms){if(!bub2){bub2=document.createElement('div');bub2.className='mg-bub pup';mg.appendChild(bub2);}bub2.textContent=txt;bub2.classList.add('on');bub2T=(ms||1800)/1000;}
function say(txt,ms){if(!bub){bub=document.createElement('div');bub.className='mg-bub';mg.appendChild(bub);}bub.textContent=txt;bub.classList.add('on');bubTimer=(ms||2400)/1000;}
function scrollTarget(){var hr=host.getBoundingClientRect();var mid=innerHeight*0.55;var idx=0;for(var i=0;i<Wp.length;i++){if(hr.top+Wp[i].y<=mid)idx=i;}var r=sec.getBoundingClientRect();if(r.bottom<innerHeight*0.7)idx=Wp.length-1;return idx;}
function wake(){idleT=0;autoT=null;Dn.sit=false;Dn.sleepy=false;Dn.pat=false;sleepSaid=false;}
function tick(now){var dt=Math.min(0.05,(now-lastT)/1000);lastT=now;if(!isFinite(dt)||dt<=0)dt=0.016;
var r=sec.getBoundingClientRect();
if(r.bottom<-100||r.top>innerHeight+100||document.hidden){mg.classList.remove('tagon');sched=requestAnimationFrame(tick);return;}mg.classList.add('tagon');
if(Math.abs(scrollY-lastScrollY)>2){lastScrollY=scrollY;wake();}
idleT+=dt;
var st=scrollTarget();var target=st;
if(hoverT!==null)target=hoverT;else if(autoT!==null&&idleT>1.2)target=autoT;
var calm=(Dn.st==='idle'||Dn.st==='run')&&target===Dn.cur&&idleT>1.2;
if(calm){aiNext-=dt;if(Dn.pat===false&&!Dn.sit){Dn.pat=true;Dn.pdir=Dn.face||1;}
 if(aiNext<=0){var roll=Math.random();
  if(idleT>40){Dn.pat=false;Dn.sit=true;Dn.sleepy=true;if(!sleepSaid){say('z z z . . .',4000);sleepSaid=true;}aiNext=6;}
  else if(roll<0.4){Dn.hopReq=true;aiNext=2.5+Math.random()*3;}
  else if(roll<0.75){var n=Dn.cur+(Math.random()<0.5?-1:1);if(n<0)n=1;if(n>Wp.length-1)n=Wp.length-2;autoT=n;autoTimer=4+Math.random()*3;dbg('mg: auto-hop to '+n);aiNext=1;}
  else{Dn.pat=false;Dn.sit=true;aiNext=1.6+Math.random();setTimeout(function(){if(!Dn.sleepy)Dn.sit=false;},1500);}}
}else{Dn.pat=false;if(!Dn.sleepy)Dn.sit=false;}
if(autoT!==null){autoTimer-=dt;if(autoTimer<=0){autoT=null;aiNext=2;}}
Dn.step(dt,target);
var pupTarget=Dn.on?Dn.cur:(Dn.tgt!=null?Dn.tgt:Dn.cur);if(Dn.st==='crouch')pupTarget=target;
if(Pp.on&&(Pp.st==='idle'||Pp.st==='run')&&Pp.cur===Dn.cur){var base=Wp[Pp.cur].x;if(cursorX!==null&&idleT>0.5){Pp.seek=Math.max(base-150,Math.min(base+150,cursorX));Pp.sit=false;}else{var side=(Pp.x<Dn.x)?-1:1;Pp.seek=Math.max(base-176,Math.min(base+176,Dn.x+side*56));if(Math.abs(Pp.seek-Pp.x)<8){Pp.sit=true;Pp.sleepy=Dn.sleepy;}else Pp.sit=false;}}else{Pp.seek=null;Pp.sit=false;}
Pp.step(dt,pupTarget);
tag.style.transform='translate('+(Dn.x-32)+'px,'+(Dn.y-Dn.h-20)+'px)';var t2=mg.querySelector('.mg-tag2');if(t2)t2.style.transform='translate('+(Pp.x-24)+'px,'+(Pp.y-Pp.h-16)+'px)';
if(Pp.sit&&!Pp.sleepy&&Pp.on){barkT-=dt;if(barkT<=0){barkT=4+Math.random()*4;if(Math.random()<0.55){bark(BARKS[Math.floor(Math.random()*BARKS.length)],1800);Pp.hopReq=true;replyT=0.9;dbg('mg: bark');}}}else barkT=Math.max(barkT,1.5);
if(replyT>0){replyT-=dt;if(replyT<=0&&(Dn.st==='idle'||Dn.st==='run')){Dn.face=Pp.x<Dn.x?-1:1;say(REPLY[Math.floor(Math.random()*REPLY.length)],2000);Dn.hopReq=true;}}
if(bub2){bub2.style.transform='translate('+(Pp.x+16)+'px,'+(Pp.y-Pp.h-40)+'px)';if(bub2T>0){bub2T-=dt;if(bub2T<=0)bub2.classList.remove('on');}}
if(bub){bub.style.transform='translate('+(Dn.x+20)+'px,'+(Dn.y-Dn.h-58)+'px)';if(bubTimer>0){bubTimer-=dt;if(bubTimer<=0)bub.classList.remove('on');}}
sched=requestAnimationFrame(tick);}
addEventListener('scroll',function(){if(started){cancelAnimationFrame(sched);tick(performance.now());}},{passive:true});
function near(){var r=sec.getBoundingClientRect();return r.bottom>-200&&r.top<innerHeight+200;}
var io=new IntersectionObserver(function(en){en.forEach(function(x){if(x.isIntersecting){start();io.disconnect();}})},{rootMargin:'200px'});io.observe(sec);
function kick(){if(!started&&near())start();}addEventListener('scroll',kick,{passive:true});addEventListener('load',kick);setTimeout(kick,1500);setTimeout(kick,4000);kick();
})();
(function(){var wrap=document.querySelector('.jwrap'),svg=document.getElementById('jtree'),trunk=document.getElementById('jtrunk'),gb=document.getElementById('jbr'),gt=document.getElementById('jtw');if(!wrap||!svg)return;
function draw(){var W=wrap.getBoundingClientRect();svg.setAttribute('viewBox','0 0 '+W.width+' '+W.height);var mob=innerWidth<761;var tx=mob?14:W.width/2;var dots=[].map.call(wrap.querySelectorAll('.jdot'),function(d){var r=d.getBoundingClientRect();return {x:r.left-W.left+r.width/2,y:r.top-W.top+r.height/2}});if(!dots.length)return;
var top=Math.max(0,dots[0].y-70),bot=Math.min(W.height,dots[dots.length-1].y+90);var amp=mob?0:18;var segs=6;var d='M'+tx+','+top;for(var i=1;i<=segs;i++){var y0=top+(bot-top)*(i-1)/segs,y1=top+(bot-top)*i/segs;d+=' C'+(tx+Math.sin(i*1.7)*amp)+','+(y0+(y1-y0)*.4)+' '+(tx+Math.sin(i*1.7+1)*amp)+','+(y0+(y1-y0)*.7)+' '+(tx+Math.sin((i+1)*1.7)*amp*.5)+','+y1;}trunk.setAttribute('d',d);trunk.setAttribute('pathLength','1');var halo=document.getElementById('jhalo');if(halo)halo.setAttribute('d',d);var lv='';function leaf(x,y,a,sc,cls,dl){return '<g transform="translate('+x+','+y+') rotate('+a+') scale('+sc+')"><path class="leaf '+cls+'" style="transition-delay:'+dl+'s" d="M0,0 C8,-12 22,-12 30,0 C22,12 8,12 0,0 Z M2,0 L28,0"/></g>';}
var bh='',th='';dots.forEach(function(p,i){var sx=tx,sy=p.y-40;var dir=p.x<tx?-1:1;var w=(6-Math.min(i,5)*.6).toFixed(1);var tX=tx+Math.sin((Math.floor((p.y-top)/((bot-top)/6))+1)*1.7)*amp*.5;sx=tX;bh+='<path pathLength="1" style="stroke-width:'+w+'px;transition-delay:'+(0.35+i*0.18)+'s" d="M'+sx+','+sy+' C'+sx+','+(sy+46)+' '+(p.x-dir*40)+','+(p.y-8)+' '+p.x+','+p.y+'"/>';var mx=(sx+p.x)/2,my=(sy+p.y)/2+10;bh+='<path pathLength="1" style="stroke-width:'+(w*.45).toFixed(1)+'px;transition-delay:'+(0.7+i*0.18)+'s" d="M'+mx+','+my+' q'+(dir*14)+',-18 '+(dir*30)+',-26"/>';th+='<path pathLength="1" style="transition-delay:'+(0.8+i*0.18)+'s" d="M'+(sx-dir*2)+','+(sy+14)+' q'+(-dir*14)+',-4 '+(-dir*26)+',-16"/><path pathLength="1" style="transition-delay:'+(0.9+i*0.18)+'s" d="M'+(p.x-dir*34)+','+(p.y-4)+' q'+(dir*4)+',-16 '+(dir*10)+',-30"/>';});for(var k=0;k<dots.length;k++){var p=dots[k],dir=p.x<tx?-1:1,sx0=tx+Math.sin((Math.floor((p.y-top)/((bot-top)/6))+1)*1.7)*amp*.5,sy0=p.y-40;var base=0.9+k*0.18;lv+=leaf(sx0-dir*2,sy0+14,dir<0?200:-20,1,'',base)+leaf(sx0-dir*26,sy0-2,dir<0?150:30,.8,'v',base+.1)+leaf((sx0+p.x)/2+dir*30,(sy0+p.y)/2-16,dir<0?215:-35,.85,'',base+.15)+leaf(p.x-dir*24,p.y-34,dir<0?250:-70,.7,'v',base+.2)+leaf(sx0+dir*6,sy0+44,dir<0?160:20,.6,'v',base+.25);}var glv=document.getElementById('jlv');if(glv)glv.innerHTML=lv;gb.innerHTML=bh;gt.innerHTML=th;}
draw();window.addEventListener('resize',draw);window.addEventListener('load',draw);setTimeout(draw,800);setTimeout(draw,2500);
var io=new IntersectionObserver(function(en){en.forEach(function(x){if(x.isIntersecting){draw();wrap.classList.add('grow');io.disconnect();}})},{threshold:.08});io.observe(wrap);})();
(function(){var wrap=document.getElementById('rright'),svg=document.getElementById('rpath'),line=document.getElementById('rline');if(!wrap||!line)return;function draw(){if(innerWidth<641){line.setAttribute('d','');return;}var pins=wrap.querySelectorAll('.pin');var W=wrap.getBoundingClientRect();svg.setAttribute('viewBox','0 0 '+W.width+' '+W.height);var pts=[].map.call(pins,function(p){var r=p.getBoundingClientRect();return {x:r.left-W.left+r.width/2,y:r.top-W.top,b:r.bottom-W.top,l:r.left-W.left,r:r.right-W.left};});var d='';for(var i=0;i<pts.length-1;i++){var a=pts[i],b=pts[i+1];var x1=(a.l+a.r)/2,y1=a.b-6,x2=(b.l+b.r)/2,y2=b.y+8;var cx=(x1+x2)/2;d+='M'+x1+','+y1+' C'+x1+','+(y1+50)+' '+x2+','+(y2-50)+' '+x2+','+y2+' ';}line.setAttribute('d',d);}
draw();window.addEventListener('resize',draw);window.addEventListener('load',draw);setTimeout(draw,600);setTimeout(draw,2000);})();
(function(){var n=document.querySelector('nav');function f(){n.classList.toggle('scrolled',window.scrollY>40)}window.addEventListener('scroll',f,{passive:true});f();})();
