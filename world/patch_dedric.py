...
JSONLD = json.dumps({"@context": "https://schema.org", "@graph": [
    {"@type": "Person", "@id": BASE + "#person", "name": "Dedric Brown", "jobTitle": "Senior Salesforce Product Manager",
     "email": "mailto:" + EMAIL, "address": {"@type": "PostalAddress", "addressLocality": "Atlanta", "addressRegion": "GA", "addressCountry": "US"},
...
<h2>St. Louis — Contact</h2><p>Open to senior product roles, Atlanta or remote across the US. <a href="mailto:{EMAIL}">{EMAIL}</a> · <a href="{CAL}">Book a call</a>.</p>
</section>""", re.S, True)
